...
def update():
    ...
    try:
        r1 = requests.get("https://521github.com/https://raw.githubusercontent.com/jiankujidu/cpolar/main/nwct_cpolar.py").text
        r2 = re.findall(re.compile("version = \d.\d"), r1)[0].split("=")[1].strip()
        if float(r2) > version:
            print("发现新版本：" + r2)
            print("正在自动更新脚本...")
            os.system("killall cpolar")
            os.system("ql raw https://521github.com/https://raw.githubusercontent.com/jiankujidu/cpolar/main/nwct_cpolar.py &")
    except:
        pass
...
def download_cpolar(cpu):
    if not os.path.exists("cpolar.py"):
        res = requests.get("https://521github.com/https://raw.githubusercontent.com/jiankujidu/cpolar/main/cpolar.py")
...
def get_url():
    try:
        ...
        return "https://521github.com/https://raw.githubusercontent.com/jiankujidu"
...
def load_send():
    ...
    if not os.path.exists(sendNotifPath):
        res = requests.get("https://521github.com/https://raw.githubusercontent.com/jiankujidu/cpolar/main/sendNotify.py")
